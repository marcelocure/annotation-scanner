...
#
# However, when we do this, we also import `my_module/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'my_module_cli = annscan.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'my_module_gui = my_module.gui:entry_point'
        # ]
    }
)
